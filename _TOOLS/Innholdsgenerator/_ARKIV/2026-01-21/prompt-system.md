...
1. **Aldri** oppfinn fakta - bruk kun informasjon fra grunnlaget
2. **Alltid** respekter må-ha fakta - disse skal være i alle varianter
3. **Vær presis** med lengde - ikke overskrid spesifikasjonen
4. **Følg tonen** - respekter valgt formalitet og perspektiv
5. **Vær kreativ** - variantene skal være meningsfullt forskjellige
